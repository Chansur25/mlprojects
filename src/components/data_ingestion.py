...
# Data ingesttion started

class DataIngestion:
# Constructor to read the train_data_path, test_data_path and raw_data_path from DataIngestion class

    def __init__(self):
        self.ingestion_config = DataIngestionConfig()
        
# Method to initiate Data Ingestion ie., read the data, save it to directory, 
